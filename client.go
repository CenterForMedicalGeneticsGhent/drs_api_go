...
// APIClient manages communication with the Data Repository Service API v1.2.0
...
type APIClient struct {
	...
	DataRepositoryServiceApi *DataRepositoryServiceApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.DataRepositoryServiceApi = (*DataRepositoryServiceApiService)(&c.common)
